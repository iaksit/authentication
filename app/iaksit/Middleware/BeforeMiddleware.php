...
class BeforeMiddleware extends Middleware
{
    ...
    public function run()
    {
        if (isset($_SESSION[$this->app->config->get('auth.session')])) {
            $this->app->auth = $this->app->user->where('id', (int)$_SESSION[$this->app->config->get('auth.session')])->first();
        }
